...
public class Spellcaster extends BaseHero{
    ...
    public Spellcaster(String className, int hp, String name, boolean team, int armor, int[] damage, int initiative,int mana) {
